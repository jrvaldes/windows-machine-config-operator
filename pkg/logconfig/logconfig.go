...
const (
	...
	// KubeLogRunnerPath is the location of kube-log-runner.exe on Windows nodes
	KubeLogRunnerPath = "C:\\k\\kube-log-runner.exe"
)
...
func GenerateKubeLogRunnerCmd(commandPath, logfilePath string) string {
